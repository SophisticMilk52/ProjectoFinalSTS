...
public class BusController {
	...
	BusDelegate busService;

	@Autowired
	public BusController(BusDelegate busService) {
	...
	public String addBuses(Model modelo) {
		...
		modelo.addAttribute("tipos", BusType.values());
	...
	public String searchBus(Tmio1Bus bus, Model modelo) {
		try {
			Tmio1Bus bus1 = busService.getBus(bus.getId());
